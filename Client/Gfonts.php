 ...
 * @Project e.com.vn
 * @Author vndes.net
 * @Copyright (C) 2015 VNDES. All rights reserved
 
 * @Createdate 30/07/2015 10:00
 */

namespace Vndes\Client;
...
class Gfonts
{
    ...
    {
        $this->cssdir = ASSETS_DIR . '/css';
        $this->fontdir = ASSETS_DIR . '/fonts';
        ...
        $this->cssRealFile = ROOTDIR . '/' . $this->cssdir . '/' . $cssFile;
        $this->cssUrlFile = BASE_SITEURL . $this->cssdir . '/' . $cssFile;
    }
    ...
    private function downloadFont($url, $dir, $filename)
    {
        ...
        curl_setopt($curlHandle, CURLOPT_USERAGENT, urlencode(USER_AGENT));
