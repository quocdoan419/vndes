...
class Request
{
    ...
    // Cac tags bi cam dung mac dinh, co the go bo bang cach thay doi cac tags cho phep cua ALLOWED_HTML_TAGS
    ...
    private function Initialize($my_domains)
    {
        ...
        $this->base_adminurl = $base_siteurl . (ADMINDIR != '' ? '/' . ADMINDIR : '');
    ...
    private function sessionStart()
    {
        ...
        session_set_cookie_params(LIVE_SESSION_TIME, $this->cookie_path, $this->cookie_domain, 0, 1);
